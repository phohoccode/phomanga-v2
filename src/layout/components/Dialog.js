            ...
            <div ref={mainRef} className="bg-[#fff] rounded-[16px] max-w-[80vw] absolute z-[1] w-[600px] shadow-custom animate-scale-in">
                ...
                <div className="p-[16px]">
                    ...
                    <div className="flex justify-end gap-[12px]">
                        <button onClick={() => setIsOpenDiaLog(false)} className="px-[8px] py-[4px] border-2 border-solid border-[#d90429] text-[#d90429] font-[600] rounded-[8px] text-lg transition-all hover:scale-[1.05]">
                            Huỷ bỏ
                        </button>
