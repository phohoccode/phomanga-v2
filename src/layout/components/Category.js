        ...
        <Fragment>
            {width > 1024 ? (
                <div
                    ...
                    <div
                        ref={modalRef}
                        className="absolute bg-[#fff] dark:bg-[#282828] shadow-custom top-[50%] translate-y-[-50%] translate-x-[-50%] left-[50%] rounded-[16px] min-w-[60%] h-auto">
                        <div className="flex justify-between p-[16px] items-center border-b-[1px] border-solid border-[#ccc]">
